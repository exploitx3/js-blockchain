...
describe('Wallet', function () {
  ...
  describe('creating a transaction', () => {
    ...
    describe('and doing the same transaction', function () {
      ...
      it('doubles the `sendAmount` output  for the recipient ', function () {
  ...
  describe('calculating a balance', function () {
    ...
    it('calculates the balance for the blockchain transactions matching the recipient', function () {
    ...
    describe('and the recipient conducts a transaction', function () {
      ...
      describe('and the sender sends another transaction to the recipient', function () {
        ...
        it('calculates the recipient balance only using transactions since its most recent one', function () {
